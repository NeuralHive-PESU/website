...
const About = () => {
  ...
  const [storyRef, storyVisible] = useScrollReveal(0.2);
  const [domainsRef, domainsVisible] = useScrollReveal(0.2);
  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      <ParallaxSection className="py-32 relative overflow-hidden" speed={0.3}>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <motion.div
            ...
            className={`holographic-card enhanced-card p-16 neon-border tilt-card scroll-reveal ${heroVisible ? 'revealed' : ''}`}
          >
      ...
      {/* Enhanced Mission Section with 3D Cards */}
      <section className="py-32 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div 
            ref={missionRef}
            className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center scroll-reveal ${missionVisible ? 'revealed' : ''}`}
          >
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className="holographic-card enhanced-card p-10 neon-border tilt-card interactive-hover"
            >
              <div className="tilt-card-content">
      ...
      {/* Enhanced Origin Story with Parallax */}
      <ParallaxSection className="py-32 relative neuron-bg" speed={0.4}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className={`holographic-card enhanced-card p-12 max-w-5xl mx-auto neon-border tilt-card scroll-reveal ${storyVisible ? 'revealed' : ''}`}
          >
            <div className="tilt-card-content">
      ...
      {/* Enhanced Domains with 3D Tilt Cards */}
      <section className="py-32 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div 
            ref={domainsRef}
            className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 scroll-reveal ${domainsVisible ? 'revealed' : ''}`}
          >
            {domains.map((domain, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="holographic-card enhanced-card p-8 text-center group neon-border tilt-card interactive-hover"
                >
                  <div className="tilt-card-content">
      ...
      {/* Enhanced Affiliations with Magnetic Effects */}
      <ParallaxSection className="py-32 relative neuron-bg" speed={0.2}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            {affiliations.map((affiliation, index) => {
              ...
              return (
                <motion.div
                  ...
                  transition={{ delay: index * 0.1, duration: 0.6 }}
                  viewport={{ once: true }}
                  className="holographic-card enhanced-card p-8 text-center neon-border tilt-card interactive-hover"
                >
                  <div className="tilt-card-content">
